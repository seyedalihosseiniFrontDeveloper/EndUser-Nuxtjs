	...
	<validation-provider v-slot="{ errors }" :rules="rules" class="relative" tag="div">
		...
		>
			<div class="switch-box relative">
				...
				/>
				<div>
					<span class="absolute right-text">قدیم</span>
					<span class="absolute left-text">جدید</span>
				</div>
			</div>
		</div>
...
<span data-v-17703830="" class="position-absolute right-text">قدیم</span>
<span data-v-17703830="" class="position-absolute left-text">جدید</span>
