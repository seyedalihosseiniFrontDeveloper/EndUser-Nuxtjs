	...
	<div>
		<div class="grid grid-cols-12 gap-4 items-center justify-center z-[1] relative w-full mt-2">
			<div class="col-span-full md:col-span-4">
				<AppBaseInput
					v-model="data.number"
					name="data.number"
					label="رقم هویة الأحوال المدنیة"
			...
			<div class="col-span-full md:col-span-4">
				<app-date-picker-custom
					rules="required"
					name="data.issuedDate"
					v-model="data.issuedDate"
					title="تاريخ هویة الأحوال المدنیة"
					:errorBoxIsVisible="false"
					:submit="true"
					simple
			...
			<div class="col-span-full md:col-span-4">
				<AppBaseInput
					...
					label="جهة هویة الأحوال المدنیة"
					:disabled="readonly"
					:classes="`!rounded-[48px] ${readonly && 'disabled-inputs'}`"
					slotIcon
				/>
			...
			<div class="col-span-full md:col-span-4">
				<AppBaseInput
					...
					tools="integer"
					:errorBoxIsVisible="false"
					name="data.folderNumber"
					v-model="data.folderNumber"
					label="رقم السجل الأحوال المدنیة"
					:disabled="readonly"
					:classes="`!rounded-[48px] ${readonly && 'disabled-inputs'}`"
					slotIcon
				/>
			...
			<div class="col-span-full md:col-span-4">
				<AppBaseInput
					...
					tools="integer"
					:errorBoxIsVisible="false"
					name="data.pageNumber"
					v-model="data.pageNumber"
					label="رقم الصحیفة هویة الأحوال المدنیة"
					:disabled="readonly"
					:classes="`!rounded-[48px] ${readonly && 'disabled-inputs'}`"
					slotIcon
				/>
		...
		<div class="grid !grid-cols-1 md:!grid-cols-2 select-type !gap-5 !pt-4 pb-4 md:px-16">
			...
			>
				...
				>
					<span class="text-black-2 group-hover:text-white pe-3 text-[12px] 3xl:text-[16px]"
						>صورة وجه هویة الأحوال المدنیة</span
					>
			...
			>
				...
				>
					<span class="text-black-2 group-hover:text-white pe-3 text-[12px] 3xl:text-[16px]"
						>صورة ظهر هویة الأحوال المدنیة</span
					>
					<i class="icon-font-add-square bg-blue-7 text-white p-[4px] rounded-[8px]"></i>
				</div>
			</div>
