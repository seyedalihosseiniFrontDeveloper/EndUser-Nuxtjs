	...
	<div class="mt-6">
		...
		<div class="grid !grid-cols-1 md:!grid-cols-2 select-type !gap-5 !pt-4 pb-4 md:px-16">
			<div
				...
				class="custom-border-dashed p-2 item !border-0 group !justify-between !h-[70px]"
			>
				<i
			...
			>
				...
				<!--					type="file"-->
				<!--					:disabled="readonly"-->
				<!--					@change="uploadImageCardId('secondImage')"-->
				<!--					class="absolute inset-0 opacity-0 cursor-pointer z-[3]"-->
				<!--				/>-->
			</div>
		</div>
	</div>
